...
from py_retro.Frontend.mainy import *
...
def RomMenu():
    ...
    while RMenu == True:
        ...
        Button(pics.w/(2560/2073),pics.h/(2160/1138),int(pics.w/12.85),int(pics.h/10.5),colors.red,colors.green,None,pics.F2, File.prompt2) 
